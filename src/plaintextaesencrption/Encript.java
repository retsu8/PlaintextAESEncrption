...
public class Encript {
    public int[] sbox = { 0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 
    ...
    public int[] tran_matrix = {2, 3, 1, 1, 1, 2, 3, 1, 1, 1, 2, 3, 3, 1, 1, 2 };
    ...
    public static void main(String[] args) {
        ...
        AESmatrix = encrypt(AESmatrix);
    }
    private static String[][] encrypt(String[][] plainMatrix) {
        for(int i =0; i<11; i++){
